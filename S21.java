package Test_smartphone;

import Test_phone.interface1.Smartphone;
...
public class S21 implements Smartphone{
	...
	public void sendSMS(String phoneNumber) {
		System.out.println(phoneNumber+"로 문제메세지를 보낸다.");
	}
	
	@Override
	public void receiveSMS(String phoneNumber) {
		System.out.println(phoneNumber+"에서 온 문제메세지를 받는다.");
	}
